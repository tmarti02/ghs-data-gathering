...
public class ParseBurkhard2 extends Parse {
	...
	public ParseBurkhard2() {
		sourceName = "Burkhard2"; // TODO Consider creating ExperimentalConstants.strSourceBurkhard2 instead.
		this.init();
	...
	private void addNewExperimentalRecord(RecordBurkhard2 rb, String propertyName, ExperimentalRecords recordsExperimental) {
		...
		if (propertyName=="LogBCFSteadyState") {
			...
			if ((rb.Log_BAF_arithmetic_or_logarithmic != null && !(rb.Log_BAF_arithmetic_or_logarithmic.isBlank())) &&
	...
	public static void main(String[] args) {
		ParseBurkhard2 p = new ParseBurkhard2();
		p.createFiles();
	}
