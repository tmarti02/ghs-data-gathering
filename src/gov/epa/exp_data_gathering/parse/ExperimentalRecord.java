...
public class ExperimentalRecord {
	...
	public void finalizeUnits() {
		if (property_name.equals(ExperimentalConstants.str_pKA) || property_name.equals(ExperimentalConstants.strHenrysLawConstant) ||
				property_name.equals(ExperimentalConstants.strLogKow)) {
			...
			if (property_value_units_original.equals(ExperimentalConstants.str_C)) {
				...
				if (property_value_point_estimate_original!=null) { property_value_point_estimate_final = (property_value_point_estimate_original-32)*5/9; }
				if (property_value_min_original!=null) { property_value_min_final = (property_value_min_original-32)*5/9; }
				if (property_value_max_original!=null) { property_value_max_final = (property_value_max_original-32)*5/9; }
			} else if (property_value_units_original.equals(ExperimentalConstants.str_K)) {
				if (property_value_point_estimate_original!=null) { property_value_point_estimate_final = property_value_point_estimate_original-273.15; }
				if (property_value_min_original!=null) { property_value_min_final = property_value_min_original-273.15; }
				if (property_value_max_original!=null) { property_value_max_final = property_value_max_original-273.15; }
			}
