...
//	class CustomComparator implements Comparator<RecordNICEATMOld>{
//	    int col;
//		
//		public int compare(RecordNICEATMOld ac1,RecordNICEATMOld ac2) {	        
...
//	}
	...
	Vector<RecordNICEATMOld> parseExcel(String filePathExcel) {
			try {
	
				Vector<RecordNICEATMOld> records = new Vector<>();
	...
	//			System.out.println(colName);
				...
				for (int i=1;i<rows;i++) {
					...
					RecordNICEATMOld r=new RecordNICEATMOld();
	...
	public static Vector<RecordNICEATMOld> parseExcel2(String filePathExcel) {
		try {
