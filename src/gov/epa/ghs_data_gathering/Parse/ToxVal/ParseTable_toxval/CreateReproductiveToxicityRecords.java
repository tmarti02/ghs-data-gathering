...
public class CreateReproductiveToxicityRecords {
	
// Replaced by CreateReproductiveDevelopmentalToxicityRecords class.
	
}


///* Inclusion criteria for Reproductive Toxicity:
//All routes
...
//
//	
//static void createReproductiveRecords(Chemical chemical, RecordToxVal r) {
...
//
//
//private static void setReproductiveDermalScore(ScoreRecord sr, Chemical chemical) {
//
//	sr.rationale = "route: " + sr.route + ", ";
//	double dose = sr.valueMass;
//	String strDose = ParseToxVal.formatDose(dose);
...
//}
//
//private void setReproductiveInhalationScore(ScoreRecord sr, Chemical chemical) {
//
//	sr.rationale = "route: " + sr.route + ", ";
//	double dose = sr.valueMass;
//	String strDose = ParseToxVal.formatDose(dose);
