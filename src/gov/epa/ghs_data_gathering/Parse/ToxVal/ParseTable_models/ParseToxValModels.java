...
//		sr.toxvalID="models_"+r.model_id;
	...
	public static ScoreRecord createScoreRecordBCF(String dtxsid,String dtxcid, String casrn,String name,
			String sourceName, String sourceOriginal,double value,String units,String note,String listType,String url) {
		
		ScoreRecord sr = new ScoreRecord(Chemical.strBioaccumulation,casrn,name);
		sr.dtxsid=dtxsid;
		sr.dtxcid=dtxcid;
		
		sr.source = sourceName;
		sr.sourceOriginal = sourceOriginal;		
		sr.listType=listType;
		sr.url=url;
//		sr.url="https://episuite.app/EpiWebSuite";
		
		sr.valueMass = Math.log10(value);
		setBioconcentrationScore(sr);
		sr.valueMassUnits="log10("+units+")";
		sr.note=note;
		return sr;
	}
...
//	}
	...
	public static ScoreRecord createScoreRecordPersistence(String dtxsid,String dtxcid, String casrn,String name,
			String sourceName, String sourceOriginal,double value,String units,String listType,String url) {
		
		ScoreRecord sr = new ScoreRecord(Chemical.strPersistence,casrn,name);
		sr.dtxsid=dtxsid;
		sr.dtxcid=dtxcid;
...
< 1.25				720									
		...
		//EPISuite and DSL for those 3604 substances that EPISuite rated as Low; there 
		//was a flaw in Todd'۪s Excel code that assigned a Low value to substances with 
		//Biowin3 output less than 2.75 (rather than 3.25) that led him to the figure."
