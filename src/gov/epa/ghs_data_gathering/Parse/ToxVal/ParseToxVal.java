...
//			writeChemicalToFile(chemical, destfilepath);
	...
	private void createScoreRecord(Chemical chemical,RecordToxVal r) {
		...
		if (r.risk_assessment_class.contentEquals("acute") && r.human_eco.contentEquals("human health")) {
			...
			CreateDevelopmentalToxicityRecords.createDevelopmentalRecords(chemical,r);
			...
			CreateEcotoxicityRecords.createEcoToxAcuteRecords(chemical,r);	
			
		} else if (r.risk_assessment_class.contentEquals("mortality:chronic")) {
			CreateEcotoxicityRecords.createEcoToxChronicRecords(chemical,r);
