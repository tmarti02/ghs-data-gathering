...
public class ChemIDPlusLD50Skin {
		...
		public static final String textFile = folder + "CAS Numbers Skin.txt";

		public static final String htmlFolder = folder + "Skin LD50 searches";

		public static final String webpageFolder = folder + "Skin LD50 webpages";
		...
		public static void main(String[] args) {
			...
			ChemIDPlusLD50Skin cs = new ChemIDPlusLD50Skin();

			cs.htmlParse(htmlFolder);
