...
public class LineSplitter {
  ...
  public static java.util.LinkedList Parse(String Line, String Delimiter) {
  ...
  public static java.util.List Parse2(String Line, String Delimiter) {
...
//		  System.out.println(c);
  ...
  public static int GetColumnNumber(String var, java.util.List l) {
  ...
  public static int FindFieldNumber(String Line, String field) {
    java.util.List myList = LineSplitter.Parse(Line, "\t");
  ...
  public static int FindFieldNumber(String Line, String field,String del) {
	    java.util.List myList = LineSplitter.Parse3(Line, del);
...
//          System.out.println(Name);
  ...
  public static java.util.List RetrieveFileList(String zipfilename) {
    // this method retrieves the list of files in a zip file (assumes no nesting)

    java.util.List myFileList = new java.util.ArrayList();
 ...
 public static java.util.List RetrieveFilesWithString(java.util.List l,
                                                String matchstring,
                                                int StartIndex) {
...
//	 String Line="\"581-12-4\",Chemidplus3DMolFile,350,\"2-Pentanone, 1-(5-(3-furyl)-2-methyl-tetrahydro-2-furyl)-4-methyl-,\"";
	 ...
	 java.util.List<String>l=LineSplitter.Parse3(Line, ",");
